...
export function DocumentViewer({ open, onClose, title, subtitle, fileName, documentNode }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-ink">
            ...
            <div className="flex flex-none items-center justify-between border-b border-ink-line/30 px-6 py-3">
                <div className="flex items-center gap-4">
                    <button type="button" onClick={onClose} className="rounded-lg p-1.5 text-steel-light transition-colors hover:bg-ink-soft hover:text-cream">
                        <X className="h-5 w-5" />
                    </button>
                    <div>
                ...
                <div className="flex items-center gap-2">
                    <Button variant="secondary" onClick={handleDownload} disabled={generating}>
