    ...
    return (
        <div className="flex h-full flex-col">
            ...
            <div className="flex items-center justify-between px-5 py-3.5">
                <h3 className="text-[11px] font-bold uppercase tracking-[0.12em] text-steel/60">
                    Evidence
                </h3>
                <button
                    type="button"
                    ...
                    {SLOTS.map((slot) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-[11px] font-medium text-steel-light">{slot.label}</p>
                            </div>
                        );
                    })}
                </div>

                <p className="max-w-[200px] text-center text-[12px] leading-relaxed text-steel/50">
