        ...
        >
            <div className="animate-global-drop-in flex flex-col items-center gap-5 text-center px-8">
                ...
                <div className="flex flex-col items-center gap-1.5">
                    <h2 className="text-[18px] font-semibold tracking-[-0.01em] text-cream">Add to this conversation</h2>
                    <p className="text-[14px] text-cream/70">Drop files anywhere to attach them</p>
                </div>
            </div>
        </div>
    );
