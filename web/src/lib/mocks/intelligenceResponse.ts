...
export const MOCK_EVIDENCE: Evidence = {
    sources: [
        { id: "src-payroll", type: "payroll", label: "Payroll records", status: "available" },
        { id: "src-loads", type: "loads", label: "Load records", status: "available" },
        { id: "src-time", type: "time", label: "Employee time entries", status: "available" },
    ],
    records: [
        {
            id: "rec-payroll-1",
