  ...
  const columns: Column<InvoiceRow>[] = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (r) => (
          <span className="font-body text-steel">
        ...
        <main className="flex-1 space-y-4 p-6">
          ...
          {state.status === "ready" && rows.length === 0 && (
            <>
              {/* Summary: all zeros */}
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                <StatCard label="Total Invoices" value={0} />
                <StatCard label="Total Invoice Amount" value={formatMoney(0)} />
                <StatCard label="Draft Invoices" value={0} />
                <StatCard
          ...
          {state.status === "ready" && rows.length > 0 && (
            <>
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                />
                <StatCard label="Draft Invoices" value={draftCount} />
                <StatCard
                  label="Average Invoice Amount"
              ...
              <div className="flex flex-wrap items-end gap-3">
                <Field label="Invoice Date From" className="min-w-35">
                  <Input
                    type="date"
                    value={dateFrom}
                ...
                {(dateFrom || dateTo) && (
                  <div className="flex items-center pb-2.5">
                    <button
                      ...
                      className="text-xs text-steel underline transition-colors hover:text-rust"
                    >
                      Clear dates
                    </button>
                  </div>
